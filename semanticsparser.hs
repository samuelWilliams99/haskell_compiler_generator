...
generatedState13 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
...
generatedState14 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
...
generatedState18 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState19 ps (x:vs) (18:ss) xs
generatedState18 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState22 ps0 (x:vs) (18:ss) xs
generatedState18 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState24 ps0 (x:vs) (18:ss) xs
generatedState18 _ _ _ xs = generatedError 18 xs


generatedState19 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState20 ps (x:vs) (19:ss) xs
generatedState19 _ _ _ xs = generatedError 19 xs


generatedState20 ps0 vs ss (x@(AbsSynToken (Token ps (TokenStringLit _))):xs) = generatedState21 ps (x:vs) (20:ss) xs
generatedState20 _ _ _ xs = generatedError 20 xs


generatedState21 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState21 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState21 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
...
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState19 ps (x:vs) (22:ss) xs
generatedState22 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState22 ps0 (x:vs) (22:ss) xs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
...
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
...
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = generatedState25 ps (x:vs) (24:ss) xs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState24 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = generatedState24 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
...
generatedState24 ps0 vs ss (x@(AbsSynResult11 _ _):xs) = generatedState109 ps0 (x:vs) (24:ss) xs
generatedState24 _ _ _ xs = generatedError 24 xs


generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState26 ps (x:vs) (25:ss) xs
...
generatedState26 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState28 ps (x:vs) (26:ss) xs
generatedState26 _ _ _ xs = generatedError 26 xs


generatedState27 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState27 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState27 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
...
generatedState29 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = generatedState25 ps (x:vs) (29:ss) xs
generatedState29 ps0 vs ss (x@(AbsSynResult18 _ _):xs) = generatedState29 ps0 (x:vs) (29:ss) xs
...
generatedState32 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState34 ps (x:vs) (32:ss) xs
generatedState32 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState35 ps (x:vs) (32:ss) xs
generatedState32 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState36 ps0 (x:vs) (32:ss) xs
...
generatedState38 ps0 vs ss (x@(AbsSynToken (Token ps (TokenUpperIdentifier _))):xs) = generatedState33 ps (x:vs) (38:ss) xs
generatedState38 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState34 ps (x:vs) (38:ss) xs
generatedState38 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState35 ps (x:vs) (38:ss) xs
...
generatedState41 ps0 vs ss (x@(AbsSynToken (Token ps (TokenUpperIdentifier _))):xs) = generatedState33 ps (x:vs) (41:ss) xs
generatedState41 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState34 ps (x:vs) (41:ss) xs
generatedState41 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState35 ps (x:vs) (41:ss) xs
generatedState41 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState42 ps0 (x:vs) (41:ss) xs
...
generatedState43 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState46 ps0 (x:vs) (43:ss) xs
generatedState43 ps0 vs ss (x@(AbsSynResult23 _ _):xs) = generatedState108 ps0 (x:vs) (43:ss) xs
...
generatedState46 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState103 ps0 (x:vs) (46:ss) xs
generatedState46 ps0 vs ss (x@(AbsSynResult27 _ _):xs) = generatedState104 ps0 (x:vs) (46:ss) xs
generatedState46 ps0 vs ss (x@(AbsSynResult25 _ _):xs) = generatedState105 ps0 (x:vs) (46:ss) xs
generatedState46 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState107 ps0 (x:vs) (46:ss) xs
...
generatedState48 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = generatedState97 ps (x:vs) (48:ss) xs
...
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState53 ps (x:vs) (51:ss) xs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenStringLit _))):xs) = generatedState54 ps (x:vs) (51:ss) xs
...
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState57 ps (x:vs) (56:ss) xs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState67 ps (x:vs) (56:ss) xs
generatedState56 ps0 vs ss (x@(AbsSynResult33 _ _):xs) = generatedState77 ps0 (x:vs) (56:ss) xs
generatedState56 ps0 vs ss (x@(AbsSynResult32 _ _):xs) = generatedState79 ps0 (x:vs) (56:ss) xs
...
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "*=>"))):xs) = generatedState61 ps (x:vs) (57:ss) xs
...
generatedState64 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState65 ps (x:vs) (64:ss) xs
...
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "^->"))):xs) = generatedState68 ps (x:vs) (67:ss) xs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "*->"))):xs) = generatedState71 ps (x:vs) (67:ss) xs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = generatedState74 ps (x:vs) (67:ss) xs
...
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState75 ps (x:vs) (74:ss) xs
...
generatedState77 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState57 ps (x:vs) (77:ss) xs
...
generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState81 ps (x:vs) (80:ss) xs
generatedState80 ps0 vs ss (x@(AbsSynResult36 _ _):xs) = generatedState87 ps0 (x:vs) (80:ss) xs
generatedState80 ps0 vs ss (x@(AbsSynResult35 _ _):xs) = generatedState89 ps0 (x:vs) (80:ss) xs
generatedState80 _ _ _ xs = generatedError 80 xs


generatedState81 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "to"))):xs) = generatedState82 ps (x:vs) (81:ss) xs
generatedState81 _ _ _ xs = generatedError 81 xs


generatedState82 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState83 ps (x:vs) (82:ss) xs
generatedState82 ps0 vs ss (x@(AbsSynResult37 _ _):xs) = generatedState86 ps0 (x:vs) (82:ss) xs
...
generatedState84 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState83 ps (x:vs) (84:ss) xs
generatedState84 ps0 vs ss (x@(AbsSynResult37 _ _):xs) = generatedState85 ps0 (x:vs) (84:ss) xs
...
generatedState92 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState93 ps (x:vs) (92:ss) xs
...
generatedState97 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState98 ps (x:vs) (97:ss) xs
...
generatedState105 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState44 ps (x:vs) (105:ss) xs
generatedState105 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState47 ps (x:vs) (105:ss) xs
generatedState105 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState103 ps0 (x:vs) (105:ss) xs
...
generatedState108 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
...
generatedState109 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState109 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction34 ps0 vs
generatedState109 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = generatedState109 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction34 ps0 vs
...
generatedState112 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState44 ps (x:vs) (112:ss) xs
generatedState112 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState46 ps0 (x:vs) (112:ss) xs
...
generatedState117 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState117 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
...
generatedState122 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState122 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction11 ps0 vs
generatedState122 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState122 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction11 ps0 vs
...
generatedState123 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState123 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
...
generatedState128 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState128 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
...
generatedReduction15 ps0 ((AbsSynResult23 v7 ps7):(AbsSynResult21 v6 ps6):(AbsSynResult20 v5 ps5):(AbsSynResult19 v4 ps4):(AbsSynResult11 v3 ps3):(AbsSynResult9 v2 ps2):(AbsSynResult22 v1 ps1):_) = AbsSynResult8 (uncurry (SemanticsDef (fromList v2) (fromList v3) v4 v5 v6 v1) $ handleStatements v7) ps1

generatedReduction16 ps0 ((AbsSynResult23 v7 ps7):(AbsSynResult21 v6 ps6):(AbsSynResult20 v5 ps5):(AbsSynResult19 v4 ps4):(AbsSynResult10 v3 ps3):(AbsSynResult9 v2 ps2):(AbsSynResult22 v1 ps1):_) = AbsSynResult8 (uncurry (SemanticsDef (fromList v2) (fromList v3) v4 v5 v6 v1) $ handleStatements v7) ps1
...
generatedReduction31 ps0 ((AbsSynToken (Token ps3 (TokenCustom "CodeBlock" v3))):(AbsSynToken (Token ps2 (TokenIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult18 ((v2, v3)) ps1

generatedReduction32 ps0 ((AbsSynToken (Token ps3 (TokenIdentifier v3))):(AbsSynToken (Token ps2 (TokenIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult18 ((v2, v3)) ps1

generatedReduction33 ps0 ((AbsSynResult16 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult19 (v2) ps1

generatedReduction34 ps0 (_) = AbsSynResult19 ("()") ps0

generatedReduction35 ps0 ((AbsSynResult16 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult20 (v2) ps1

generatedReduction36 ps0 (_) = AbsSynResult20 ("()") ps0
