...
generatedState0 ps0 vs ss (x@(AbsSynResult1 _ _):xs) = generatedState130 ps0 (x:vs) (0:ss) xs
...
generatedState3 ps0 vs ss (x@(AbsSynResult3 _ _):xs) = generatedState119 ps0 (x:vs) (3:ss) xs
...
generatedState7 ps0 vs ss (x@(AbsSynResult5 _ _):xs) = generatedState114 ps0 (x:vs) (7:ss) xs
...
generatedState11 ps0 vs ss (x@(AbsSynResult7 _ _):xs) = generatedState112 ps0 (x:vs) (11:ss) xs
...
generatedState16 ps0 vs ss (x@(AbsSynResult8 _ _):xs) = generatedState111 ps0 (x:vs) (16:ss) xs
...
generatedState22 ps0 vs ss (x@(AbsSynResult11 _ _):xs) = generatedState106 ps0 (x:vs) (22:ss) xs
...
generatedState40 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState41 ps (x:vs) (40:ss) xs
generatedState40 ps0 vs ss (x@(AbsSynResult25 _ _):xs) = generatedState43 ps0 (x:vs) (40:ss) xs
generatedState40 ps0 vs ss (x@(AbsSynResult22 _ _):xs) = generatedState105 ps0 (x:vs) (40:ss) xs
generatedState40 _ _ _ xs = generatedError 40 xs


generatedState41 ps0 vs ss (x@(AbsSynToken (Token ps (TokenUpperIdentifier _))):xs) = generatedState42 ps (x:vs) (41:ss) xs
...
generatedState42 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction42 ps0 vs
...
generatedState43 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState41 ps (x:vs) (43:ss) xs
generatedState43 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState44 ps (x:vs) (43:ss) xs
generatedState43 ps0 vs ss (x@(AbsSynResult25 _ _):xs) = generatedState100 ps0 (x:vs) (43:ss) xs
generatedState43 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState101 ps0 (x:vs) (43:ss) xs
generatedState43 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState102 ps0 (x:vs) (43:ss) xs
generatedState43 ps0 vs ss (x@(AbsSynResult23 _ _):xs) = generatedState104 ps0 (x:vs) (43:ss) xs
generatedState43 _ _ _ xs = generatedError 43 xs


generatedState44 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState45 ps (x:vs) (44:ss) xs
generatedState44 _ _ _ xs = generatedError 44 xs


generatedState45 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "=>"))):xs) = generatedState46 ps (x:vs) (45:ss) xs
generatedState45 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = generatedState94 ps (x:vs) (45:ss) xs
...
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState47 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (47:ss) xs
generatedState47 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState52 ps0 (x:vs) (47:ss) xs
...
generatedState48 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState50 ps (x:vs) (48:ss) xs
generatedState48 ps0 vs ss (x@(AbsSynToken (Token ps (TokenStringLit _))):xs) = generatedState51 ps (x:vs) (48:ss) xs
generatedState48 _ _ _ xs = generatedError 48 xs


generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState49 _ _ _ xs = generatedError 49 xs


generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction50 ps0 vs
...
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState52 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState52 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState52 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState52 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState53 ps (x:vs) (52:ss) xs
generatedState52 ps0 vs ss (x@(AbsSynResult30 _ _):xs) = generatedState88 ps0 (x:vs) (52:ss) xs
generatedState52 _ _ _ xs = generatedError 52 xs


generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState54 ps (x:vs) (53:ss) xs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState64 ps (x:vs) (53:ss) xs
generatedState53 ps0 vs ss (x@(AbsSynResult32 _ _):xs) = generatedState74 ps0 (x:vs) (53:ss) xs
generatedState53 ps0 vs ss (x@(AbsSynResult31 _ _):xs) = generatedState76 ps0 (x:vs) (53:ss) xs
generatedState53 _ _ _ xs = generatedError 53 xs


generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "^=>"))):xs) = generatedState55 ps (x:vs) (54:ss) xs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "*=>"))):xs) = generatedState58 ps (x:vs) (54:ss) xs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "=>"))):xs) = generatedState61 ps (x:vs) (54:ss) xs
...
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState56 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (56:ss) xs
generatedState56 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState57 ps0 (x:vs) (56:ss) xs
generatedState56 _ _ _ xs = generatedError 56 xs


generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction62 ps0 vs
generatedState57 _ _ _ xs = generatedError 57 xs


generatedState58 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState59 ps (x:vs) (58:ss) xs
...
generatedState59 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState59 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState59 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (59:ss) xs
generatedState59 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState60 ps0 (x:vs) (59:ss) xs
...
generatedState61 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState62 ps (x:vs) (61:ss) xs
...
generatedState62 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState62 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState62 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (62:ss) xs
generatedState62 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState63 ps0 (x:vs) (62:ss) xs
...
generatedState64 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "*->"))):xs) = generatedState68 ps (x:vs) (64:ss) xs
generatedState64 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = generatedState71 ps (x:vs) (64:ss) xs
generatedState64 _ _ _ xs = generatedError 64 xs


generatedState65 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState66 ps (x:vs) (65:ss) xs
generatedState65 _ _ _ xs = generatedError 65 xs


generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState66 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState66 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (66:ss) xs
generatedState66 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState67 ps0 (x:vs) (66:ss) xs
generatedState66 _ _ _ xs = generatedError 66 xs


generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 3)) ps (drop 4 vs) (drop 4 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState67 _ _ _ xs = generatedError 67 xs


generatedState68 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState69 ps (x:vs) (68:ss) xs
...
generatedState69 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState69 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState69 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (69:ss) xs
generatedState69 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState70 ps0 (x:vs) (69:ss) xs
...
generatedState71 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState72 ps (x:vs) (71:ss) xs
...
generatedState72 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState72 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState72 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (72:ss) xs
generatedState72 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState73 ps0 (x:vs) (72:ss) xs
...
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState54 ps (x:vs) (74:ss) xs
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState64 ps (x:vs) (74:ss) xs
generatedState74 ps0 vs ss (x@(AbsSynResult32 _ _):xs) = generatedState74 ps0 (x:vs) (74:ss) xs
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState74 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
...
generatedState75 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState75 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState75 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState75 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState75 _ _ _ xs = generatedError 75 xs


generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState76 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction64 ps0 vs
generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState76 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction64 ps0 vs
generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState76 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction64 ps0 vs
generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState76 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction64 ps0 vs
generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = generatedState77 ps (x:vs) (76:ss) xs
generatedState76 ps0 vs ss (x@(AbsSynResult33 _ _):xs) = generatedState87 ps0 (x:vs) (76:ss) xs
...
generatedState77 ps0 vs ss (x@(AbsSynResult35 _ _):xs) = generatedState84 ps0 (x:vs) (77:ss) xs
generatedState77 ps0 vs ss (x@(AbsSynResult34 _ _):xs) = generatedState86 ps0 (x:vs) (77:ss) xs
generatedState77 _ _ _ xs = generatedError 77 xs


generatedState78 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "to"))):xs) = generatedState79 ps (x:vs) (78:ss) xs
...
generatedState79 ps0 vs ss (x@(AbsSynResult36 _ _):xs) = generatedState83 ps0 (x:vs) (79:ss) xs
generatedState79 _ _ _ xs = generatedError 79 xs


generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction69 ps0 vs
generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction69 ps0 vs
generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction69 ps0 vs
generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction69 ps0 vs
generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction69 ps0 vs
generatedState80 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator ","))):xs) = generatedState81 ps (x:vs) (80:ss) xs
generatedState80 _ _ _ xs = generatedError 80 xs


generatedState81 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState80 ps (x:vs) (81:ss) xs
generatedState81 ps0 vs ss (x@(AbsSynResult36 _ _):xs) = generatedState82 ps0 (x:vs) (81:ss) xs
...
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction67 ps0 vs
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction67 ps0 vs
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction67 ps0 vs
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction67 ps0 vs
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction67 ps0 vs
generatedState83 _ _ _ xs = generatedError 83 xs


generatedState84 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState78 ps (x:vs) (84:ss) xs
generatedState84 ps0 vs ss (x@(AbsSynResult35 _ _):xs) = generatedState84 ps0 (x:vs) (84:ss) xs
generatedState84 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction66 ps0 vs
generatedState84 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction66 ps0 vs
generatedState84 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction66 ps0 vs
generatedState84 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction66 ps0 vs
generatedState84 ps0 vs ss (x@(AbsSynResult34 _ _):xs) = generatedState85 ps0 (x:vs) (84:ss) xs
...
generatedState86 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction63 ps0 vs
generatedState86 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction63 ps0 vs
generatedState86 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction63 ps0 vs
...
generatedState87 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction53 ps0 vs
generatedState87 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction53 ps0 vs
generatedState87 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction53 ps0 vs
generatedState87 _ _ _ xs = generatedError 87 xs


generatedState88 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState89 ps (x:vs) (88:ss) xs
...
generatedState88 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState88 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction47 ps0 vs
generatedState88 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState88 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction47 ps0 vs
generatedState88 ps0 vs ss (x@(AbsSynResult37 _ _):xs) = generatedState91 ps0 (x:vs) (88:ss) xs
generatedState88 ps0 vs ss (x@(AbsSynResult27 _ _):xs) = generatedState92 ps0 (x:vs) (88:ss) xs
generatedState88 ps0 vs ss (x@(AbsSynResult28 _ _):xs) = generatedState93 ps0 (x:vs) (88:ss) xs
generatedState88 _ _ _ xs = generatedError 88 xs


generatedState89 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState90 ps (x:vs) (89:ss) xs
generatedState89 _ _ _ xs = generatedError 89 xs


generatedState90 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction70 ps0 vs
generatedState90 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction70 ps0 vs
generatedState90 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction70 ps0 vs
...
generatedState91 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction48 ps0 vs
generatedState91 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction48 ps0 vs
generatedState91 _ _ _ xs = generatedError 91 xs


generatedState92 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction46 ps0 vs
generatedState92 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction46 ps0 vs
generatedState92 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction46 ps0 vs
generatedState92 _ _ _ xs = generatedError 92 xs


generatedState93 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction45 ps0 vs
generatedState93 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction45 ps0 vs
generatedState93 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction45 ps0 vs
generatedState93 _ _ _ xs = generatedError 93 xs


generatedState94 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState95 ps (x:vs) (94:ss) xs
generatedState94 _ _ _ xs = generatedError 94 xs


generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState95 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState48 ps (x:vs) (95:ss) xs
generatedState95 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState96 ps0 (x:vs) (95:ss) xs
...
generatedState96 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState96 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState96 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState96 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState96 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState96 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState96 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState96 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction54 ps0 vs
generatedState96 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState53 ps (x:vs) (96:ss) xs
generatedState96 ps0 vs ss (x@(AbsSynResult30 _ _):xs) = generatedState97 ps0 (x:vs) (96:ss) xs
generatedState96 _ _ _ xs = generatedError 96 xs


generatedState97 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState89 ps (x:vs) (97:ss) xs
...
generatedState97 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState97 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction47 ps0 vs
generatedState97 ps0 vs ss (x@(AbsSynResult37 _ _):xs) = generatedState91 ps0 (x:vs) (97:ss) xs
generatedState97 ps0 vs ss (x@(AbsSynResult27 _ _):xs) = generatedState98 ps0 (x:vs) (97:ss) xs
generatedState97 ps0 vs ss (x@(AbsSynResult28 _ _):xs) = generatedState99 ps0 (x:vs) (97:ss) xs
...
generatedState98 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction44 ps0 vs
generatedState98 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction44 ps0 vs
generatedState98 _ _ _ xs = generatedError 98 xs


generatedState99 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction43 ps0 vs
generatedState99 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction43 ps0 vs
generatedState99 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction43 ps0 vs
generatedState99 _ _ _ xs = generatedError 99 xs


generatedState100 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState100 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState100 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState100 _ _ _ xs = generatedError 100 xs


generatedState101 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction40 ps0 vs
generatedState101 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction40 ps0 vs
generatedState101 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction40 ps0 vs
generatedState101 _ _ _ xs = generatedError 101 xs


generatedState102 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState41 ps (x:vs) (102:ss) xs
generatedState102 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState44 ps (x:vs) (102:ss) xs
generatedState102 ps0 vs ss (x@(AbsSynResult25 _ _):xs) = generatedState100 ps0 (x:vs) (102:ss) xs
generatedState102 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState101 ps0 (x:vs) (102:ss) xs
generatedState102 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState102 ps0 (x:vs) (102:ss) xs
...
generatedState102 ps0 vs ss (x@(AbsSynResult23 _ _):xs) = generatedState103 ps0 (x:vs) (102:ss) xs
generatedState102 _ _ _ xs = generatedError 102 xs


generatedState103 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction38 ps0 vs
generatedState103 _ _ _ xs = generatedError 103 xs


generatedState104 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction37 ps0 vs
generatedState104 _ _ _ xs = generatedError 104 xs


generatedState105 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 5)) ps (drop 6 vs) (drop 6 ss) (x':x:xs)
...
generatedState106 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState106 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction33 ps0 vs
generatedState106 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = generatedState106 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction33 ps0 vs
generatedState106 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState106 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction33 ps0 vs
generatedState106 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = generatedState29 ps (x:vs) (106:ss) xs
generatedState106 ps0 vs ss (x@(AbsSynResult19 _ _):xs) = generatedState107 ps0 (x:vs) (106:ss) xs
generatedState106 _ _ _ xs = generatedError 106 xs


generatedState107 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState107 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction35 ps0 vs
generatedState107 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = generatedState35 ps (x:vs) (107:ss) xs
generatedState107 ps0 vs ss (x@(AbsSynResult20 _ _):xs) = generatedState108 ps0 (x:vs) (107:ss) xs
generatedState107 _ _ _ xs = generatedError 107 xs


generatedState108 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState38 ps (x:vs) (108:ss) xs
generatedState108 ps0 vs ss (x@(AbsSynResult21 _ _):xs) = generatedState109 ps0 (x:vs) (108:ss) xs
generatedState108 _ _ _ xs = generatedError 108 xs


generatedState109 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState41 ps (x:vs) (109:ss) xs
generatedState109 ps0 vs ss (x@(AbsSynResult25 _ _):xs) = generatedState43 ps0 (x:vs) (109:ss) xs
generatedState109 ps0 vs ss (x@(AbsSynResult22 _ _):xs) = generatedState110 ps0 (x:vs) (109:ss) xs
generatedState109 _ _ _ xs = generatedError 109 xs


generatedState110 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 5)) ps (drop 6 vs) (drop 6 ss) (x':x:xs)
...
generatedState112 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState17 ps (x:vs) (112:ss) xs
generatedState112 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState20 ps0 (x:vs) (112:ss) xs
generatedState112 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState22 ps0 (x:vs) (112:ss) xs
generatedState112 ps0 vs ss (x@(AbsSynResult8 _ _):xs) = generatedState113 ps0 (x:vs) (112:ss) xs
generatedState112 _ _ _ xs = generatedError 112 xs


generatedState113 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 4)) ps (drop 5 vs) (drop 5 ss) (x':x:xs)
  where x' = generatedReduction7 ps0 vs
generatedState113 _ _ _ xs = generatedError 113 xs


generatedState114 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "outputprecode"))):xs) = generatedState12 ps (x:vs) (114:ss) xs
generatedState114 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState114 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState114 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState15 ps0 (x:vs) (114:ss) xs
...
generatedState117 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState17 ps (x:vs) (117:ss) xs
generatedState117 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState20 ps0 (x:vs) (117:ss) xs
generatedState117 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState22 ps0 (x:vs) (117:ss) xs
generatedState117 ps0 vs ss (x@(AbsSynResult8 _ _):xs) = generatedState118 ps0 (x:vs) (117:ss) xs
generatedState117 _ _ _ xs = generatedError 117 xs


generatedState118 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 4)) ps (drop 5 vs) (drop 5 ss) (x':x:xs)
  where x' = generatedReduction5 ps0 vs
generatedState118 _ _ _ xs = generatedError 118 xs


generatedState119 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "precode"))):xs) = generatedState8 ps (x:vs) (119:ss) xs
generatedState119 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState119 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction11 ps0 vs
generatedState119 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState119 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction11 ps0 vs
generatedState119 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "outputprecode"))):xs) = generatedState119 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction11 ps0 vs
generatedState119 ps0 vs ss (x@(AbsSynResult14 _ _):xs) = generatedState10 ps0 (x:vs) (119:ss) xs
generatedState119 ps0 vs ss (x@(AbsSynResult4 _ _):xs) = generatedState120 ps0 (x:vs) (119:ss) xs
generatedState119 ps0 vs ss (x@(AbsSynResult5 _ _):xs) = generatedState125 ps0 (x:vs) (119:ss) xs
generatedState119 _ _ _ xs = generatedError 119 xs


generatedState120 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "outputprecode"))):xs) = generatedState12 ps (x:vs) (120:ss) xs
generatedState120 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState120 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState120 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState15 ps0 (x:vs) (120:ss) xs
generatedState120 ps0 vs ss (x@(AbsSynResult6 _ _):xs) = generatedState121 ps0 (x:vs) (120:ss) xs
generatedState120 ps0 vs ss (x@(AbsSynResult7 _ _):xs) = generatedState123 ps0 (x:vs) (120:ss) xs
generatedState120 _ _ _ xs = generatedError 120 xs


generatedState121 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState17 ps (x:vs) (121:ss) xs
generatedState121 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState20 ps0 (x:vs) (121:ss) xs
generatedState121 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState22 ps0 (x:vs) (121:ss) xs
...
generatedState123 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState17 ps (x:vs) (123:ss) xs
generatedState123 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState20 ps0 (x:vs) (123:ss) xs
generatedState123 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState22 ps0 (x:vs) (123:ss) xs
generatedState123 ps0 vs ss (x@(AbsSynResult8 _ _):xs) = generatedState124 ps0 (x:vs) (123:ss) xs
generatedState123 _ _ _ xs = generatedError 123 xs


generatedState124 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 4)) ps (drop 5 vs) (drop 5 ss) (x':x:xs)
  where x' = generatedReduction3 ps0 vs
generatedState124 _ _ _ xs = generatedError 124 xs


generatedState125 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "outputprecode"))):xs) = generatedState12 ps (x:vs) (125:ss) xs
generatedState125 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState125 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState125 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState15 ps0 (x:vs) (125:ss) xs
generatedState125 ps0 vs ss (x@(AbsSynResult6 _ _):xs) = generatedState126 ps0 (x:vs) (125:ss) xs
generatedState125 ps0 vs ss (x@(AbsSynResult7 _ _):xs) = generatedState128 ps0 (x:vs) (125:ss) xs
...
generatedState128 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState17 ps (x:vs) (128:ss) xs
generatedState128 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState20 ps0 (x:vs) (128:ss) xs
generatedState128 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState22 ps0 (x:vs) (128:ss) xs
generatedState128 ps0 vs ss (x@(AbsSynResult8 _ _):xs) = generatedState129 ps0 (x:vs) (128:ss) xs
generatedState128 _ _ _ xs = generatedError 128 xs


generatedState129 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 4)) ps (drop 5 vs) (drop 5 ss) (x':x:xs)
  where x' = generatedReduction1 ps0 vs
generatedState129 _ _ _ xs = generatedError 129 xs


generatedState130 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = return $ unpackFinal $ head vs
...
generatedReduction15 ps0 ((AbsSynResult22 v6 ps6):(AbsSynResult21 v5 ps5):(AbsSynResult20 v4 ps4):(AbsSynResult19 v3 ps3):(AbsSynResult11 v2 ps2):(AbsSynResult9 v1 ps1):_) = AbsSynResult8 (uncurry (SemanticsDef (fromList v1) (fromList v2) v3 v4 v5) $ handleStatements v6) ps1

generatedReduction16 ps0 ((AbsSynResult22 v6 ps6):(AbsSynResult21 v5 ps5):(AbsSynResult20 v4 ps4):(AbsSynResult19 v3 ps3):(AbsSynResult10 v2 ps2):(AbsSynResult9 v1 ps1):_) = AbsSynResult8 (uncurry (SemanticsDef (fromList v1) (fromList v2) v3 v4 v5) $ handleStatements v6) ps1
...
generatedReduction37 ps0 ((AbsSynResult23 v2 ps2):(AbsSynResult25 v1 ps1):_) = AbsSynResult22 ((Right v1):v2) ps1

generatedReduction38 ps0 ((AbsSynResult23 v2 ps2):(AbsSynResult24 v1 ps1):_) = AbsSynResult23 (v1:v2) ps1

generatedReduction39 ps0 ((AbsSynResult24 v1 ps1):_) = AbsSynResult23 ([v1]) ps1

generatedReduction40 ps0 ((AbsSynResult26 v1 ps1):_) = AbsSynResult24 (Left v1) ps1

generatedReduction41 ps0 ((AbsSynResult25 v1 ps1):_) = AbsSynResult24 (Right v1) ps1

generatedReduction42 ps0 ((AbsSynToken (Token ps2 (TokenUpperIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult25 (v2) ps1

generatedReduction43 ps0 ((AbsSynResult28 v7 ps7):(AbsSynResult30 v6 ps6):(AbsSynResult29 v5 ps5):(AbsSynToken (Token ps4 (TokenCustom "CodeBlock" v4))):(AbsSynToken (Token ps3 v3)):(AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult26 (uncurry (SemanticsRule v2 v4 False v5 "" v7) v6) ps1

generatedReduction44 ps0 ((AbsSynResult27 v7 ps7):(AbsSynResult30 v6 ps6):(AbsSynResult29 v5 ps5):(AbsSynToken (Token ps4 (TokenCustom "CodeBlock" v4))):(AbsSynToken (Token ps3 v3)):(AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult26 (uncurry (SemanticsRule v2 v4 False v5 "" v7) v6) ps1

generatedReduction45 ps0 ((AbsSynResult28 v7 ps7):(AbsSynResult30 v6 ps6):(AbsSynResult29 v5 ps5):(AbsSynToken (Token ps4 (TokenCustom "CodeBlock" v4))):(AbsSynToken (Token ps3 v3)):(AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult26 (uncurry (SemanticsRule v2 v4 True v5 "" v7) v6) ps1

generatedReduction46 ps0 ((AbsSynResult27 v7 ps7):(AbsSynResult30 v6 ps6):(AbsSynResult29 v5 ps5):(AbsSynToken (Token ps4 (TokenCustom "CodeBlock" v4))):(AbsSynToken (Token ps3 v3)):(AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult26 (uncurry (SemanticsRule v2 v4 True v5 "" v7) v6) ps1

generatedReduction47 ps0 (_) = AbsSynResult27 (empty) ps0

generatedReduction48 ps0 ((AbsSynResult37 v1 ps1):_) = AbsSynResult28 (Just v1) ps1

generatedReduction49 ps0 ((AbsSynToken (Token ps2 (TokenStringLit v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult29 (SemanticsStaticBaseType v2) ps1

generatedReduction50 ps0 ((AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult29 (SemanticsStaticType v2) ps1

generatedReduction51 ps0 ((AbsSynToken (Token ps2 (TokenIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult29 (SemanticsVarType v2) ps1

generatedReduction52 ps0 (_) = AbsSynResult29 (SemanticsCommandType) ps0

generatedReduction53 ps0 ((AbsSynResult33 v3 ps3):(AbsSynResult31 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult30 ((v2, v3)) ps1

generatedReduction54 ps0 (_) = AbsSynResult30 (([], [])) ps0

generatedReduction55 ps0 ((AbsSynResult31 v2 ps2):(AbsSynResult32 v1 ps1):_) = AbsSynResult31 (v1:v2) ps1

generatedReduction56 ps0 ((AbsSynResult32 v1 ps1):_) = AbsSynResult31 ([v1]) ps1

generatedReduction57 ps0 ((AbsSynResult29 v4 ps4):(AbsSynToken (Token ps3 (TokenIdentifier v3))):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult32 (SemanticsRuleDependency v1 v3 (RawSemanticsDepType v4) False SemanticsDepSingle) ps1

generatedReduction58 ps0 ((AbsSynResult29 v4 ps4):(AbsSynToken (Token ps3 (TokenIdentifier v3))):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult32 (SemanticsRuleDependency v1 v3 (RawSemanticsDepType v4) False (SemanticsDepFold False)) ps1

generatedReduction59 ps0 ((AbsSynResult29 v4 ps4):(AbsSynToken (Token ps3 (TokenIdentifier v3))):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult32 (SemanticsRuleDependency v1 v3 (RawSemanticsDepType v4) False (SemanticsDepFold True)) ps1

generatedReduction60 ps0 ((AbsSynResult29 v4 ps4):(AbsSynToken (Token ps3 (TokenCustom "CodeBlock" v3))):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenCustom "CodeBlock" v1))):_) = AbsSynResult32 (SemanticsRuleDependency v1 v3 (RawSemanticsDepType v4) True  SemanticsDepSingle) ps1

generatedReduction61 ps0 ((AbsSynResult29 v4 ps4):(AbsSynToken (Token ps3 (TokenCustom "CodeBlock" v3))):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenCustom "CodeBlock" v1))):_) = AbsSynResult32 (SemanticsRuleDependency v1 v3 (RawSemanticsDepType v4) True  (SemanticsDepFold False)) ps1

generatedReduction62 ps0 ((AbsSynResult29 v4 ps4):(AbsSynToken (Token ps3 (TokenCustom "CodeBlock" v3))):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenCustom "CodeBlock" v1))):_) = AbsSynResult32 (SemanticsRuleDependency v1 v3 (RawSemanticsDepType v4) True  (SemanticsDepFold True)) ps1

generatedReduction63 ps0 ((AbsSynResult34 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult33 (v2) ps1

generatedReduction64 ps0 (_) = AbsSynResult33 ([]) ps0

generatedReduction65 ps0 ((AbsSynResult34 v2 ps2):(AbsSynResult35 v1 ps1):_) = AbsSynResult34 (v1:v2) ps1

generatedReduction66 ps0 ((AbsSynResult35 v1 ps1):_) = AbsSynResult34 ([v1]) ps1

generatedReduction67 ps0 ((AbsSynResult36 v3 ps3):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult35 (SemanticsTypeRestriction v1 v3) ps1

generatedReduction68 ps0 ((AbsSynResult36 v3 ps3):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult36 (v1:v3) ps1

generatedReduction69 ps0 ((AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult36 ([v1]) ps1

generatedReduction70 ps0 ((AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult37 (v2) ps1
