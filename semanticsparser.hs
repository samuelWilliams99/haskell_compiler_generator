...
generatedState11 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState11 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState11 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState16 ps0 (x:vs) (11:ss) xs
generatedState11 ps0 vs ss (x@(AbsSynResult6 _ _):xs) = generatedState17 ps0 (x:vs) (11:ss) xs
...
generatedState12 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (12:ss) xs
generatedState12 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (12:ss) xs
generatedState12 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState15 ps0 (x:vs) (12:ss) xs
...
generatedState15 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction25 ps0 vs
generatedState15 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction25 ps0 vs
generatedState15 _ _ _ xs = generatedError 15 xs


generatedState16 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction14 ps0 vs
generatedState16 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction14 ps0 vs
generatedState16 _ _ _ xs = generatedError 16 xs


generatedState17 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState17 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState17 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (17:ss) xs
generatedState17 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (17:ss) xs
generatedState17 ps0 vs ss (x@(AbsSynResult8 _ _):xs) = generatedState104 ps0 (x:vs) (17:ss) xs
generatedState17 _ _ _ xs = generatedError 17 xs


generatedState18 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction40 ps0 vs
generatedState18 _ _ _ xs = generatedError 18 xs


generatedState19 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState20 ps (x:vs) (19:ss) xs
generatedState19 ps0 vs ss (x@(AbsSynResult19 _ _):xs) = generatedState23 ps0 (x:vs) (19:ss) xs
generatedState19 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState25 ps0 (x:vs) (19:ss) xs
generatedState19 _ _ _ xs = generatedError 19 xs


generatedState20 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState21 ps (x:vs) (20:ss) xs
...
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction32 ps0 vs
generatedState22 _ _ _ xs = generatedError 22 xs


generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState20 ps (x:vs) (23:ss) xs
generatedState23 ps0 vs ss (x@(AbsSynResult19 _ _):xs) = generatedState23 ps0 (x:vs) (23:ss) xs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction18 ps0 vs
generatedState23 ps0 vs ss (x@(AbsSynResult9 _ _):xs) = generatedState24 ps0 (x:vs) (23:ss) xs
generatedState23 _ _ _ xs = generatedError 23 xs


generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState24 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction17 ps0 vs
generatedState24 _ _ _ xs = generatedError 24 xs


generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = generatedState26 ps (x:vs) (25:ss) xs
generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState25 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = generatedState25 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = generatedState25 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState25 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
generatedState25 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState25 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction19 ps0 vs
generatedState25 ps0 vs ss (x@(AbsSynResult20 _ _):xs) = generatedState29 ps0 (x:vs) (25:ss) xs
generatedState25 ps0 vs ss (x@(AbsSynResult10 _ _):xs) = generatedState31 ps0 (x:vs) (25:ss) xs
generatedState25 ps0 vs ss (x@(AbsSynResult11 _ _):xs) = generatedState99 ps0 (x:vs) (25:ss) xs
generatedState25 _ _ _ xs = generatedError 25 xs


generatedState26 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState27 ps (x:vs) (26:ss) xs
generatedState26 _ _ _ xs = generatedError 26 xs


generatedState27 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (27:ss) xs
generatedState27 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (27:ss) xs
generatedState27 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState28 ps0 (x:vs) (27:ss) xs
...
generatedState28 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 2)) ps (drop 3 vs) (drop 3 ss) (x':x:xs)
  where x' = generatedReduction33 ps0 vs
...
generatedState29 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "paramtype"))):xs) = generatedState26 ps (x:vs) (29:ss) xs
generatedState29 ps0 vs ss (x@(AbsSynResult20 _ _):xs) = generatedState29 ps0 (x:vs) (29:ss) xs
generatedState29 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction21 ps0 vs
generatedState29 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction21 ps0 vs
generatedState29 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction21 ps0 vs
...
generatedState30 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction20 ps0 vs
generatedState30 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction20 ps0 vs
...
generatedState31 ps0 vs ss (x@(AbsSynResult21 _ _):xs) = generatedState36 ps0 (x:vs) (31:ss) xs
generatedState31 _ _ _ xs = generatedError 31 xs


generatedState32 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (32:ss) xs
generatedState32 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (32:ss) xs
generatedState32 ps0 vs ss (x@(AbsSynToken (Token ps (TokenUpperIdentifier _))):xs) = generatedState33 ps (x:vs) (32:ss) xs
generatedState32 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState34 ps0 (x:vs) (32:ss) xs
generatedState32 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState35 ps0 (x:vs) (32:ss) xs
...
generatedState35 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction34 ps0 vs
generatedState35 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction34 ps0 vs
generatedState35 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction34 ps0 vs
generatedState35 _ _ _ xs = generatedError 35 xs


generatedState36 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState36 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction37 ps0 vs
generatedState36 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState36 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction37 ps0 vs
generatedState36 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState36 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction37 ps0 vs
generatedState36 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = generatedState37 ps (x:vs) (36:ss) xs
generatedState36 ps0 vs ss (x@(AbsSynResult22 _ _):xs) = generatedState39 ps0 (x:vs) (36:ss) xs
generatedState36 _ _ _ xs = generatedError 36 xs


generatedState37 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (37:ss) xs
generatedState37 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (37:ss) xs
generatedState37 ps0 vs ss (x@(AbsSynToken (Token ps (TokenUpperIdentifier _))):xs) = generatedState33 ps (x:vs) (37:ss) xs
generatedState37 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState34 ps0 (x:vs) (37:ss) xs
generatedState37 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState38 ps0 (x:vs) (37:ss) xs
generatedState37 _ _ _ xs = generatedError 37 xs


generatedState38 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction36 ps0 vs
generatedState38 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction36 ps0 vs
generatedState38 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction36 ps0 vs
generatedState38 _ _ _ xs = generatedError 38 xs


generatedState39 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState39 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction39 ps0 vs
generatedState39 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState40 ps (x:vs) (39:ss) xs
generatedState39 ps0 vs ss (x@(AbsSynResult23 _ _):xs) = generatedState42 ps0 (x:vs) (39:ss) xs
generatedState39 _ _ _ xs = generatedError 39 xs


generatedState40 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (40:ss) xs
generatedState40 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (40:ss) xs
generatedState40 ps0 vs ss (x@(AbsSynToken (Token ps (TokenUpperIdentifier _))):xs) = generatedState33 ps (x:vs) (40:ss) xs
generatedState40 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState34 ps0 (x:vs) (40:ss) xs
generatedState40 ps0 vs ss (x@(AbsSynResult17 _ _):xs) = generatedState41 ps0 (x:vs) (40:ss) xs
generatedState40 _ _ _ xs = generatedError 40 xs


generatedState41 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
...
generatedState42 ps0 vs ss (x@(AbsSynResult28 _ _):xs) = generatedState45 ps0 (x:vs) (42:ss) xs
generatedState42 ps0 vs ss (x@(AbsSynResult25 _ _):xs) = generatedState98 ps0 (x:vs) (42:ss) xs
...
generatedState45 ps0 vs ss (x@(AbsSynResult28 _ _):xs) = generatedState93 ps0 (x:vs) (45:ss) xs
generatedState45 ps0 vs ss (x@(AbsSynResult30 _ _):xs) = generatedState94 ps0 (x:vs) (45:ss) xs
generatedState45 ps0 vs ss (x@(AbsSynResult27 _ _):xs) = generatedState95 ps0 (x:vs) (45:ss) xs
generatedState45 ps0 vs ss (x@(AbsSynResult26 _ _):xs) = generatedState97 ps0 (x:vs) (45:ss) xs
...
generatedState47 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = generatedState49 ps (x:vs) (47:ss) xs
generatedState47 ps0 vs ss (x@(AbsSynResult29 _ _):xs) = generatedState50 ps0 (x:vs) (47:ss) xs
generatedState47 _ _ _ xs = generatedError 47 xs


generatedState48 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction49 ps0 vs
generatedState48 _ _ _ xs = generatedError 48 xs


generatedState49 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction48 ps0 vs
generatedState49 _ _ _ xs = generatedError 49 xs


generatedState50 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState51 ps (x:vs) (50:ss) xs
generatedState50 _ _ _ xs = generatedError 50 xs


generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState51 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState51 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState52 ps (x:vs) (51:ss) xs
generatedState51 ps0 vs ss (x@(AbsSynResult33 _ _):xs) = generatedState58 ps0 (x:vs) (51:ss) xs
generatedState51 _ _ _ xs = generatedError 51 xs


generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState53 ps (x:vs) (52:ss) xs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState54 ps (x:vs) (52:ss) xs
generatedState52 ps0 vs ss (x@(AbsSynResult18 _ _):xs) = generatedState55 ps0 (x:vs) (52:ss) xs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState56 ps (x:vs) (52:ss) xs
generatedState52 ps0 vs ss (x@(AbsSynToken (Token ps (TokenStringLit _))):xs) = generatedState57 ps (x:vs) (52:ss) xs
generatedState52 _ _ _ xs = generatedError 52 xs


generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "to"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "~"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction31 ps0 vs
generatedState53 _ _ _ xs = generatedError 53 xs


generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "to"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "~"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction30 ps0 vs
generatedState54 _ _ _ xs = generatedError 54 xs


generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction56 ps0 vs
generatedState55 _ _ _ xs = generatedError 55 xs


generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
generatedState56 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
  where x' = generatedReduction55 ps0 vs
...
generatedState58 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = generatedState58 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction59 ps0 vs
generatedState58 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState59 ps (x:vs) (58:ss) xs
generatedState58 ps0 vs ss (x@(AbsSynResult34 _ _):xs) = generatedState87 ps0 (x:vs) (58:ss) xs
generatedState58 _ _ _ xs = generatedError 58 xs


generatedState59 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (59:ss) xs
generatedState59 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (59:ss) xs
generatedState59 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState60 ps0 (x:vs) (59:ss) xs
generatedState59 ps0 vs ss (x@(AbsSynResult39 _ _):xs) = generatedState73 ps0 (x:vs) (59:ss) xs
generatedState59 ps0 vs ss (x@(AbsSynResult35 _ _):xs) = generatedState75 ps0 (x:vs) (59:ss) xs
generatedState59 _ _ _ xs = generatedError 59 xs


generatedState60 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = generatedState60 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction63 ps0 vs
generatedState60 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "*->"))):xs) = generatedState60 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction63 ps0 vs
generatedState60 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "^->"))):xs) = generatedState60 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction63 ps0 vs
generatedState60 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "~"))):xs) = generatedState61 ps (x:vs) (60:ss) xs
generatedState60 ps0 vs ss (x@(AbsSynResult36 _ _):xs) = generatedState63 ps0 (x:vs) (60:ss) xs
generatedState60 _ _ _ xs = generatedError 60 xs


generatedState61 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (61:ss) xs
generatedState61 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (61:ss) xs
...
generatedState62 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "->"))):xs) = (generatedStates !! (ss !! 1)) ps (drop 2 vs) (drop 2 ss) (x':x:xs)
...
generatedState63 ps0 vs ss (x@(AbsSynResult38 _ _):xs) = generatedState67 ps0 (x:vs) (63:ss) xs
...
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState53 ps (x:vs) (67:ss) xs
generatedState67 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState54 ps (x:vs) (67:ss) xs
...
generatedState68 ps0 vs ss (x@(AbsSynResult37 _ _):xs) = generatedState71 ps0 (x:vs) (68:ss) xs
generatedState68 _ _ _ xs = generatedError 68 xs


generatedState69 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState53 ps (x:vs) (69:ss) xs
generatedState69 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState54 ps (x:vs) (69:ss) xs
...
generatedState71 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "evaluating"))):xs) = generatedState71 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction57 ps0 vs
generatedState71 ps0 vs ss (x@(AbsSynToken (Token ps (TokenOperator "@"))):xs) = generatedState52 ps (x:vs) (71:ss) xs
...
generatedState73 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState13 ps (x:vs) (73:ss) xs
generatedState73 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "CodeBlock" _))):xs) = generatedState14 ps (x:vs) (73:ss) xs
generatedState73 ps0 vs ss (x@(AbsSynResult16 _ _):xs) = generatedState60 ps0 (x:vs) (73:ss) xs
generatedState73 ps0 vs ss (x@(AbsSynResult39 _ _):xs) = generatedState73 ps0 (x:vs) (73:ss) xs
...
generatedState73 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "restricting"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction61 ps0 vs
generatedState73 ps0 vs ss (x@(AbsSynResult35 _ _):xs) = generatedState74 ps0 (x:vs) (73:ss) xs
...
generatedState75 ps0 vs ss (x@(AbsSynResult40 _ _):xs) = generatedState86 ps0 (x:vs) (75:ss) xs
generatedState75 _ _ _ xs = generatedError 75 xs


generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState53 ps (x:vs) (76:ss) xs
generatedState76 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState54 ps (x:vs) (76:ss) xs
generatedState76 ps0 vs ss (x@(AbsSynResult18 _ _):xs) = generatedState77 ps0 (x:vs) (76:ss) xs
generatedState76 ps0 vs ss (x@(AbsSynResult42 _ _):xs) = generatedState83 ps0 (x:vs) (76:ss) xs
generatedState76 ps0 vs ss (x@(AbsSynResult41 _ _):xs) = generatedState85 ps0 (x:vs) (76:ss) xs
...
generatedState78 ps0 vs ss (x@(AbsSynResult43 _ _):xs) = generatedState82 ps0 (x:vs) (78:ss) xs
...
generatedState80 ps0 vs ss (x@(AbsSynResult43 _ _):xs) = generatedState81 ps0 (x:vs) (80:ss) xs
...
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "IdentifierPrime" _))):xs) = generatedState53 ps (x:vs) (83:ss) xs
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenIdentifier _))):xs) = generatedState54 ps (x:vs) (83:ss) xs
generatedState83 ps0 vs ss (x@(AbsSynResult18 _ _):xs) = generatedState77 ps0 (x:vs) (83:ss) xs
generatedState83 ps0 vs ss (x@(AbsSynResult42 _ _):xs) = generatedState83 ps0 (x:vs) (83:ss) xs
...
generatedState83 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "where"))):xs) = (generatedStates !! (ss !! 0)) ps (drop 1 vs) (drop 1 ss) (x':x:xs)
  where x' = generatedReduction73 ps0 vs
generatedState83 ps0 vs ss (x@(AbsSynResult41 _ _):xs) = generatedState84 ps0 (x:vs) (83:ss) xs
...
generatedState87 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState87 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction52 ps0 vs
generatedState87 ps0 vs ss (x@(AbsSynResult44 _ _):xs) = generatedState90 ps0 (x:vs) (87:ss) xs
generatedState87 ps0 vs ss (x@(AbsSynResult31 _ _):xs) = generatedState91 ps0 (x:vs) (87:ss) xs
generatedState87 ps0 vs ss (x@(AbsSynResult32 _ _):xs) = generatedState92 ps0 (x:vs) (87:ss) xs
...
generatedState91 ps0 vs ss (x@(AbsSynToken (Token ps (TokenEOF))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState91 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
generatedState91 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = (generatedStates !! (ss !! 6)) ps (drop 7 vs) (drop 7 ss) (x':x:xs)
  where x' = generatedReduction51 ps0 vs
...
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState43 ps (x:vs) (95:ss) xs
generatedState95 ps0 vs ss (x@(AbsSynToken (Token ps (TokenKeyword "case"))):xs) = generatedState46 ps (x:vs) (95:ss) xs
generatedState95 ps0 vs ss (x@(AbsSynResult28 _ _):xs) = generatedState93 ps0 (x:vs) (95:ss) xs
generatedState95 ps0 vs ss (x@(AbsSynResult30 _ _):xs) = generatedState94 ps0 (x:vs) (95:ss) xs
...
generatedState99 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState99 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction35 ps0 vs
generatedState99 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "stateextra"))):xs) = generatedState32 ps (x:vs) (99:ss) xs
...
generatedState100 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState100 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction37 ps0 vs
generatedState100 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "varextra"))):xs) = generatedState37 ps (x:vs) (100:ss) xs
...
generatedState101 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState101 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction39 ps0 vs
generatedState101 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "standardenv"))):xs) = generatedState40 ps (x:vs) (101:ss) xs
...
generatedState102 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "asttype"))):xs) = generatedState43 ps (x:vs) (102:ss) xs
generatedState102 ps0 vs ss (x@(AbsSynResult28 _ _):xs) = generatedState45 ps0 (x:vs) (102:ss) xs
...
generatedState105 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState105 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState105 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (105:ss) xs
generatedState105 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (105:ss) xs
...
generatedState107 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState107 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState107 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState16 ps0 (x:vs) (107:ss) xs
...
generatedState108 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState108 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState108 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (108:ss) xs
generatedState108 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (108:ss) xs
...
generatedState110 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState110 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState110 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (110:ss) xs
generatedState110 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (110:ss) xs
...
generatedState113 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState113 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState113 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState16 ps0 (x:vs) (113:ss) xs
...
generatedState114 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState114 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState114 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (114:ss) xs
generatedState114 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (114:ss) xs
...
generatedState116 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState116 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState116 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (116:ss) xs
generatedState116 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (116:ss) xs
...
generatedState118 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState118 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction13 ps0 vs
generatedState118 ps0 vs ss (x@(AbsSynResult15 _ _):xs) = generatedState16 ps0 (x:vs) (118:ss) xs
...
generatedState119 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState119 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState119 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (119:ss) xs
generatedState119 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (119:ss) xs
...
generatedState121 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "basetype"))):xs) = generatedState121 ps (drop 0 vs) (drop 0 ss) (x':x:xs)
  where x' = generatedReduction41 ps0 vs
generatedState121 ps0 vs ss (x@(AbsSynToken (Token ps (TokenCustom "Directive" "hasincludes"))):xs) = generatedState18 ps (x:vs) (121:ss) xs
generatedState121 ps0 vs ss (x@(AbsSynResult24 _ _):xs) = generatedState19 ps0 (x:vs) (121:ss) xs
...
generatedReduction28 ps0 ((AbsSynResult16 v1 ps1):_) = AbsSynResult17 (v1) ps1

generatedReduction29 ps0 ((AbsSynToken (Token ps1 (TokenUpperIdentifier v1))):_) = AbsSynResult17 (v1) ps1

generatedReduction30 ps0 ((AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult18 (v1) ps1

generatedReduction31 ps0 ((AbsSynToken (Token ps1 (TokenCustom "IdentifierPrime" v1))):_) = AbsSynResult18 (v1) ps1

generatedReduction32 ps0 ((AbsSynToken (Token ps3 (TokenStringLit v3))):(AbsSynToken (Token ps2 (TokenIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult19 ((v2, v3)) ps1

generatedReduction33 ps0 ((AbsSynResult16 v3 ps3):(AbsSynToken (Token ps2 (TokenIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult20 ((v2, v3)) ps1

generatedReduction34 ps0 ((AbsSynResult17 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult21 (v2) ps1

generatedReduction35 ps0 (_) = AbsSynResult21 ("()") ps0

generatedReduction36 ps0 ((AbsSynResult17 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult22 (v2) ps1

generatedReduction37 ps0 (_) = AbsSynResult22 ("()") ps0

generatedReduction38 ps0 ((AbsSynResult17 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult23 (v2) ps1

generatedReduction39 ps0 (_) = AbsSynResult23 ("return ()") ps0

generatedReduction40 ps0 ((AbsSynToken (Token ps1 v1)):_) = AbsSynResult24 (True) ps1

generatedReduction41 ps0 (_) = AbsSynResult24 (False) ps0

generatedReduction42 ps0 ((AbsSynResult26 v2 ps2):(AbsSynResult28 v1 ps1):_) = AbsSynResult25 ((Right v1):v2) ps1

generatedReduction43 ps0 ((AbsSynResult26 v2 ps2):(AbsSynResult27 v1 ps1):_) = AbsSynResult26 (v1:v2) ps1

generatedReduction44 ps0 ((AbsSynResult27 v1 ps1):_) = AbsSynResult26 ([v1]) ps1

generatedReduction45 ps0 ((AbsSynResult30 v1 ps1):_) = AbsSynResult27 (Left v1) ps1

generatedReduction46 ps0 ((AbsSynResult28 v1 ps1):_) = AbsSynResult27 (Right v1) ps1

generatedReduction47 ps0 ((AbsSynToken (Token ps2 (TokenUpperIdentifier v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult28 (v2) ps1

generatedReduction48 ps0 ((AbsSynToken (Token ps1 v1)):_) = AbsSynResult29 (False) ps1

generatedReduction49 ps0 ((AbsSynToken (Token ps1 v1)):_) = AbsSynResult29 (True) ps1

generatedReduction50 ps0 ((AbsSynResult32 v7 ps7):(AbsSynResult34 v6 ps6):(AbsSynResult33 v5 ps5):(AbsSynToken (Token ps4 (TokenCustom "CodeBlock" v4))):(AbsSynResult29 v3 ps3):(AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult30 (uncurry (SemanticsRule v2 v4 v3 v5 "" v7) v6) ps1

generatedReduction51 ps0 ((AbsSynResult31 v7 ps7):(AbsSynResult34 v6 ps6):(AbsSynResult33 v5 ps5):(AbsSynToken (Token ps4 (TokenCustom "CodeBlock" v4))):(AbsSynResult29 v3 ps3):(AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult30 (uncurry (SemanticsRule v2 v4 v3 v5 "" v7) v6) ps1

generatedReduction52 ps0 (_) = AbsSynResult31 (empty) ps0

generatedReduction53 ps0 ((AbsSynResult44 v1 ps1):_) = AbsSynResult32 (Just v1) ps1

generatedReduction54 ps0 ((AbsSynToken (Token ps2 (TokenStringLit v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult33 (SemanticsStaticBaseType v2) ps1

generatedReduction55 ps0 ((AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult33 (SemanticsStaticType v2) ps1

generatedReduction56 ps0 ((AbsSynResult18 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult33 (SemanticsVarType v2) ps1

generatedReduction57 ps0 (_) = AbsSynResult33 (SemanticsCommandType) ps0

generatedReduction58 ps0 ((AbsSynResult40 v3 ps3):(AbsSynResult35 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult34 ((v2, v3)) ps1

generatedReduction59 ps0 (_) = AbsSynResult34 (([], [])) ps0

generatedReduction60 ps0 ((AbsSynResult35 v2 ps2):(AbsSynResult39 v1 ps1):_) = AbsSynResult35 (v1:v2) ps1

generatedReduction61 ps0 ((AbsSynResult39 v1 ps1):_) = AbsSynResult35 ([v1]) ps1

generatedReduction62 ps0 ((AbsSynResult16 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult36 (v2) ps1

generatedReduction63 ps0 (_) = AbsSynResult36 ("env") ps0

generatedReduction64 ps0 ((AbsSynResult18 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult37 (v2) ps1

generatedReduction65 ps0 (_) = AbsSynResult37 ("_") ps0

generatedReduction66 ps0 ((AbsSynToken (Token ps1 v1)):_) = AbsSynResult38 (SemanticsDepSingle) ps1

generatedReduction67 ps0 ((AbsSynToken (Token ps1 v1)):_) = AbsSynResult38 (SemanticsDepFold False) ps1

generatedReduction68 ps0 ((AbsSynToken (Token ps1 v1)):_) = AbsSynResult38 (SemanticsDepFold True) ps1

generatedReduction69 ps0 ((AbsSynResult33 v6 ps6):(AbsSynResult37 v5 ps5):(AbsSynResult18 v4 ps4):(AbsSynResult38 v3 ps3):(AbsSynResult36 v2 ps2):(AbsSynResult16 v1 ps1):_) = AbsSynResult39 (SemanticsRuleDependency v1 v2 v4 v5 (RawSemanticsDepType v6) v3) ps1

generatedReduction70 ps0 ((AbsSynResult41 v2 ps2):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult40 (v2) ps1

generatedReduction71 ps0 (_) = AbsSynResult40 ([]) ps0

generatedReduction72 ps0 ((AbsSynResult41 v2 ps2):(AbsSynResult42 v1 ps1):_) = AbsSynResult41 (v1:v2) ps1

generatedReduction73 ps0 ((AbsSynResult42 v1 ps1):_) = AbsSynResult41 ([v1]) ps1

generatedReduction74 ps0 ((AbsSynResult43 v3 ps3):(AbsSynToken (Token ps2 v2)):(AbsSynResult18 v1 ps1):_) = AbsSynResult42 (SemanticsTypeRestriction v1 v3) ps1

generatedReduction75 ps0 ((AbsSynResult43 v3 ps3):(AbsSynToken (Token ps2 v2)):(AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult43 (v1:v3) ps1

generatedReduction76 ps0 ((AbsSynToken (Token ps1 (TokenIdentifier v1))):_) = AbsSynResult43 ([v1]) ps1

generatedReduction77 ps0 ((AbsSynToken (Token ps2 (TokenCustom "CodeBlock" v2))):(AbsSynToken (Token ps1 v1)):_) = AbsSynResult44 (v2) ps1
