...
import MtParser
import MtSemantics
data Flag = Ext | Info | Verbose | Output String | Dep String deriving (Show, Eq)
...
main = do
    ...
    else runCompiler (head args) (getOutputPath flags) (elem Verbose flags) (getDepPaths flags)
